##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.2.0-B44] date: [Sun Jan 07 01:12:25 CST 2024] 
##########################################################################################################################
...
Core/Src/rtc.c \
C:/Users/LC/STM32Cube/Repository/STM32Cube_FW_F4_V1.28.0/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rtc.c \
C:/Users/LC/STM32Cube/Repository/STM32Cube_FW_F4_V1.28.0/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rtc_ex.c \
Core/Src/usart.c \
C:/Users/LC/STM32Cube/Repository/STM32Cube_FW_F4_V1.28.0/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c \
Core/Src/dma.c
...
#######################################
clean:
	-pwsh -c "Remove-Item -Force -Recurse $(BUILD_DIR)"
...
#######################################
download:
	-openocd -f D:\CLI-Tools\openocd\share\openocd\scripts\interface\jlink-swd.cfg -f D:\CLI-Tools\openocd\share\openocd\scripts\target\stm32f4x.cfg -c init -c "reset halt; wait_halt; flash write_image erase build/OLED.hex" -c reset -c shutdown
